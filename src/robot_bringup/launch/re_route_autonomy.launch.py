...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(bringup_dir, 'rviz', 'remote_view.rviz')
    ...
    pointcloud_adapter_node = Node(
        ...
        remappings=[
        # <--- 修改! 让它订阅rtabmap发布的局部地图 --->
        ('/camera/depth_registered/points', '/odom_local_map')
    ]
    )
    ...
    far_planner_node = Node(
        ...
        remappings=[
            ...
            ('/terrain_local_cloud', '/odom_local_map')
        ]
    )
