...
bool osr_interfaces__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("osr_interfaces.msg._status.Status", full_classname_dest, 33) == 0);
  }
  osr_interfaces__msg__Status * ros_message = _ros_message;
  {  // battery
  ...
  {  // error_status
    ...
    }
    {
      ...
      Py_ssize_t size = 3;
      rosidl_runtime_c__String * dest = ros_message->error_status;
...
PyObject * osr_interfaces__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("osr_interfaces.msg._status");
  ...
  {  // error_status
    PyObject * field = NULL;
    size_t size = 3;
    rosidl_runtime_c__String * src = ros_message->error_status;
