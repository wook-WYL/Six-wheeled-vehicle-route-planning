...
static const _OptimizationStats_type_support_symbol_names_t _OptimizationStats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arise_slam_mid360_msgs, msg, OptimizationStats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arise_slam_mid360_msgs, msg, OptimizationStats)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arise_slam_mid360_msgs, msg, OptimizationStats)() {
  return &::arise_slam_mid360_msgs::msg::rosidl_typesupport_c::OptimizationStats_message_type_support_handle;
}
