...
#include "arise_slam_mid360_msgs/msg/detail/iteration_stats__rosidl_typesupport_fastrtps_c.h"
...
using _IterationStats__ros_msg_type = arise_slam_mid360_msgs__msg__IterationStats;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IterationStats__ros_msg_type * ros_message = static_cast<const _IterationStats__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: translation_norm
  {
    cdr << ros_message->translation_norm;
  }

  // Field name: rotation_norm
  {
    cdr << ros_message->rotation_norm;
  }

  // Field name: num_surf_from_scan
  {
    cdr << ros_message->num_surf_from_scan;
  }

  // Field name: num_corner_from_scan
  {
  ...
  void * untyped_ros_message)
{
  ...
  _IterationStats__ros_msg_type * ros_message = static_cast<_IterationStats__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _IterationStats__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arise_slam_mid360_msgs__msg__IterationStats(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arise_slam_mid360_msgs__msg__IterationStats;
    is_plain =
      (
...
static size_t _IterationStats__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arise_slam_mid360_msgs__msg__IterationStats(
...
static message_type_support_callbacks_t __callbacks_IterationStats = {
...
static rosidl_message_type_support_t _IterationStats__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IterationStats,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arise_slam_mid360_msgs, msg, IterationStats)() {
  return &_IterationStats__type_support;
}
