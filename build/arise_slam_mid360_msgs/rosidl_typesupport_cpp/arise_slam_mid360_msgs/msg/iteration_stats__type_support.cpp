...
static const _IterationStats_type_support_symbol_names_t _IterationStats_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arise_slam_mid360_msgs, msg, IterationStats)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arise_slam_mid360_msgs, msg, IterationStats)),
  }
};
...
{
  return &::arise_slam_mid360_msgs::msg::rosidl_typesupport_cpp::IterationStats_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arise_slam_mid360_msgs, msg, IterationStats)() {
  return get_message_type_support_handle<arise_slam_mid360_msgs::msg::IterationStats>();
}
