...
#include "visibility_graph_msg/msg/detail/graph__rosidl_typesupport_fastrtps_c.h"
...
#include "visibility_graph_msg/msg/detail/node__functions.h"  // nodes
...
using _Graph__ros_msg_type = visibility_graph_msg__msg__Graph;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, visibility_graph_msg, msg, Node
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      visibility_graph_msg__msg__Node__Sequence__fini(&ros_message->nodes);
    }
...
size_t get_serialized_size_visibility_graph_msg__msg__Graph(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Graph__ros_msg_type * ros_message = static_cast<const _Graph__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_visibility_graph_msg__msg__Node(
...
static uint32_t _Graph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_visibility_graph_msg__msg__Graph(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_visibility_graph_msg
size_t max_serialized_size_visibility_graph_msg__msg__Graph(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_visibility_graph_msg__msg__Node(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = visibility_graph_msg__msg__Graph;
    is_plain =
      (
...
static size_t _Graph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_visibility_graph_msg__msg__Graph(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, visibility_graph_msg, msg, Graph)() {
