...
static const _LegMotors_type_support_symbol_names_t _LegMotors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motion_msgs, msg, LegMotors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motion_msgs, msg, LegMotors)),
  }
};
...
{
  return &::motion_msgs::msg::rosidl_typesupport_cpp::LegMotors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motion_msgs, msg, LegMotors)() {
  return get_message_type_support_handle<motion_msgs::msg::LegMotors>();
}
