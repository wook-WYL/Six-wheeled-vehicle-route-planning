...
static const _MovementCtrlData_type_support_symbol_names_t _MovementCtrlData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motion_msgs, msg, MovementCtrlData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motion_msgs, msg, MovementCtrlData)),
  }
};
...
{
  return &::motion_msgs::msg::rosidl_typesupport_cpp::MovementCtrlData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motion_msgs, msg, MovementCtrlData)() {
  return get_message_type_support_handle<motion_msgs::msg::MovementCtrlData>();
}
