...
bool domain_bridge__msg__compressed_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("domain_bridge.msg._compressed_msg.CompressedMsg", full_classname_dest, 47) == 0);
  }
  domain_bridge__msg__CompressedMsg * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of CompressedMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("domain_bridge.msg._compressed_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CompressedMsg");
