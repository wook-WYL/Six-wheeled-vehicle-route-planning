...
bool ception_msgs__msg__imu_euler__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ception_msgs.msg._imu_euler.IMUEuler", full_classname_dest, 36) == 0);
  }
  ception_msgs__msg__IMUEuler * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of IMUEuler */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ception_msgs.msg._imu_euler");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IMUEuler");
